...
public class AppConfig {
	...
	/** 拍照存储图片文件夹路径 */
	public static final String IMAGE_FOLDER_PATH = SCLUI_FOLDER_PATH + IMAGE_FOLDER_NAME;

	/** 下载的图片的文件夹 */
	public static final String DOWNLOAD_FOLDER_NAME = "/download/";
	/** 下载的图片的文件夹路径 */
	public static final String DOWNLOAD_FOLDER_PATH = SCLUI_FOLDER_PATH + DOWNLOAD_FOLDER_NAME;

	/** 下载的图片的文件夹 */
	public static final String DOWNLOAD_VIDEO_FOLDER_NAME = "/video/";
	/** 下载的图片的文件夹路径 */
	public static final String DOWNLOAD_VIDEO_FOLDER_PATH = DOWNLOAD_FOLDER_PATH + DOWNLOAD_VIDEO_FOLDER_NAME;

	/** 保存的图片的文件夹 */
	public static final String SAVE_FOLDER_NAME = "/save/";
	/** 保存的图片的文件夹路径 */
	public static final String SAVE_FOLDER_PATH = SCLUI_FOLDER_PATH + SAVE_FOLDER_NAME;
	...
	/** 下载的个人头像的储存路径 */
	public static final String TEMP_IMAGE_NAME = DOWNLOAD_FOLDER_PATH + "temp.jpg";

	/** 下载的公司LOGO的储存路径 */
	public static final String DOWNLOAD_LOGO_NAME = DOWNLOAD_FOLDER_PATH + "logo_pic.jpg";
